...
public partial class rptCustomerInformation : System.Web.UI.Page
{
    string qry;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if(txtName.Text=="")
        {
            qry = "SELECT CustomerName,CustomerCompany,CustomerContact,CustomerEmail FROM tblCustomerInfo WHERE CustomerCompany LIKE '" + txtName.Text + "%'";
        }
        else
        {
            qry = "SELECT CustomerName,CustomerCompany,CustomerContact,CustomerEmail FROM tblCustomerInfo WHERE CustomerCompany LIKE '" + txtName.Text + "'";
