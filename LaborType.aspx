<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin.master" AutoEventWireup="true" CodeFile="LaborType.aspx.cs" Inherits="LaborType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center><h1 style="font-family:Georgia">Labor Type</h1><br />
         <asp:Panel ID="pnlTable" runat="server">
<table>
    <tr>
    <th><strong>Labor Type:</strong></th>
    <td>
        <asp:textbox ID="txtLaborType" MaxLength="15" Placeholder="Enter Labor Type" runat="server"></asp:textbox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLaborType" ErrorMessage="Type must be required" ForeColor="Red">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td colspan="2">
