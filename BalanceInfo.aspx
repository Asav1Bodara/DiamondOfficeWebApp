<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin.master" AutoEventWireup="true" CodeFile="BalanceInfo.aspx.cs" Inherits="BalanceInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center><h1 style="font-family:Georgia">Balance Information</h1>
    <br />
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDiamondRate" MaxLength="20" Placeholder="Enter Diamond Rate" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDiamondRate" ErrorMessage="Diamond Rate Required" ForeColor="Red">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLaborRate" ErrorMessage="Labor Rate Required" ForeColor="Red">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2">
